...
| GPT-4.1 | 安定选项 | コストパフォーマンス | ¥0.003/1K tokens |
| Claude 4 | 文章仕上げ | 自然な表現 | ¥0.005/1K tokens |
| Claude 3.5 | 安定した仕上げ | バランスの良い出力 | ¥0.0045/1K tokens |
| SakuraLLM | 日本語特化 | 日本語の機微 | ¥0.001/1K tokens |
| Matsuri | 日本語小説 | 小説特化モデル | ¥0.0012/1K tokens |
| DeepSeek-V2 | 大量生成 | 最高のコスパ | ¥0.0002/1K tokens |
| Qwen-JP | 日本語特化 | 高品質な日本語 | ¥0.0004/1K tokens |
